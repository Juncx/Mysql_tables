...
enum RISK_FORCE_CLOSE_TIME_INFO_TABLE_DESC : int {
	E_RIFOCLTIIN_RISKID = 0,
	E_RIFOCLTIIN_RISKMODULEID,
	E_RIFOCLTIIN_PRODUCTID,
	E_RIFOCLTIIN_FORCETIME1,
	E_RIFOCLTIIN_FORCETIME2,
	E_RIFOCLTIIN_RISKSTATUS,
	E_RIFOCLTIIN_END
};

const char* const RISK_FORCE_CLOSE_TIME_INFO_TABLE = "risk_force_close_time_info";

const char* const RISK_FORCE_CLOSE_TIME_INFO_TABLE_COLS[E_RIFOCLTIIN_END] = {
	"riskID",
	"riskModuleID",
	"productID",
	"forceTime1",
...
const char* const RISK_FORCE_CLOSE_TIME_INFO_TABLE_COLS_ATTR[E_RIFOCLTIIN_END] = {
