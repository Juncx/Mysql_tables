...
enum USER_MONEY_INFO_TABLE_DESC : int {
	E_USMOIN_USERID = 0,
	E_USMOIN_USERDEPOSIT,
	E_USMOIN_EQUIPMENT,
	E_USMOIN_PREBALANCE,
	E_USMOIN_CURRENTTOTAL,
	E_USMOIN_FROZENOUTMONEY,
	E_USMOIN_TODAYCLOSEPROFIT,
	E_USMOIN_TODAYFEE,
	E_USMOIN_TODAYINMONEY,
	E_USMOIN_TODAYOUTMONEY,
	E_USMOIN_HISTORYPROFIT,
	E_USMOIN_HISTORYFEE,
	E_USMOIN_HISTORYOUTMONEY,
	E_USMOIN_HISTORYINMONEY,
	E_USMOIN_END
};

const char* const USER_MONEY_INFO_TABLE = "user_money_info";

const char* const USER_MONEY_INFO_TABLE_COLS[E_USMOIN_END] = {
	"userID",
	"userDeposit",
	"equipment",
	"preBalance",
...
const char* const USER_MONEY_INFO_TABLE_COLS_ATTR[E_USMOIN_END] = {
