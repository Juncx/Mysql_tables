...
enum CONDITION_HISTORY_ORDERS_TABLE_DESC : int {
	E_COHIOR_CONDITIONORDERID = 0,
	E_COHIOR_USERID,
	E_COHIOR_CONTRACTID,
	E_COHIOR_CONDITIONTYPE,
	E_COHIOR_TRIGGERPRICETYPE,
	E_COHIOR_TRIGGERCONDITION,
	E_COHIOR_TRIGGERPRICE,
	E_COHIOR_TRIGGERTIME,
	E_COHIOR_TIMECONDITIONTYPE,
	E_COHIOR_ORDERTYPE,
	E_COHIOR_ORDERPRICE,
	E_COHIOR_DIRECTION,
	E_COHIOR_OPENOFFSET,
	...
	E_COHIOR_MAC,
	E_COHIOR_ORDERID,
	E_COHIOR_TRIGGERCONTIME,
	E_COHIOR_TRIGGERCONDATE,
	E_COHIOR_TRIGGERDATE,
	E_COHIOR_END
};

const char* const CONDITION_HISTORY_ORDERS_TABLE = "condition_history_orders";

const char* const CONDITION_HISTORY_ORDERS_TABLE_COLS[E_COHIOR_END] = {
	"conditionOrderID",
	"userID",
	"contractID",
	"conditionType",
...
const char* const CONDITION_HISTORY_ORDERS_TABLE_COLS_ATTR[E_COHIOR_END] = {
